...
def process_fingerprints_parallel(input_file, output_file, timeout=5):
    """
...
# 使用示例
input_file = "/data/user2/wty/HOF/ML_method/all.json"  # 输入 JSON 文件路径
output_file = "/data/user2/wty/HOF/ML_method/all_fp.json"  # 输出 JSON 文件路径
process_fingerprints_parallel(input_file, output_file, timeout=5)
