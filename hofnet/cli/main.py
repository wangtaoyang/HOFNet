...
from hofnet import __version__

commands = [
    #('info' , 'hofnet.cli.info'),
    ('install-griday' , 'hofnet.cli.install_griday'),
    ('uninstall-griday', 'hofnet.cli.uninstall_griday'),
    ('run', 'hofnet.cli.run'),
    ('download', 'hofnet.cli.download'),
]


def main(prog='hofnet', version=__version__, commands=commands, args=None):
