class CLICommand:
    ...
    def add_arguments(parser):
        from hofnet.utils.download import DEFAULT_PRETRAIN_MODEL_PATH, DEFAULT_COREMOF_PATH, DEFAULT_QMOF_PATH
